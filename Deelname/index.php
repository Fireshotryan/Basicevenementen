...
<div class="max-w-sm rounded overflow-hidden mr-16 mb-4 shadow-md w-full md:w-1/3 xl:w-1/4 p-6 flex flex-col">
  
    <img class="object-fill h-64 w-96" src="../images/<?= $evenement['image'] ?>"/>
