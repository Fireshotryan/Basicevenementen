    ...
    <nav aria-label="menu nav" class="bg-gray-800 pt-2 md:pt-1 pb-1 px-1 mt-0 h-auto fixed w-full z-20 top-0">
        ...
        <div class="flex flex-wrap items-center">
            ...
            <div class="flex flex-1 md:w-1/3 justify-center md:justify-start text-white px-2">
                ...
                <form action="../Deelname/zoekevenementen.php" method="GET">
                ...
                <ul class="list-reset flex justify-between flex-1 md:flex-none items-center">
                    ...
                    <li class="flex-1 md:flex-none md:mr-3">
                        <div class="relative inline-block">
                            <button onclick="toggleDD('myDropdown')" class="drop-button text-white py-2 px-14"> <span class="pr-2"></i></span> Hi, <?= $name ?> <svg class="h-3 fill-current inline" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
            ...
            <div id="main" class="main-content flex-1 bg-gray-100 mt-12 md:mt-2 pb-24 md:pb-5">
                ...
                <div class="bg-gray-800 pt-3">
                    <div class="rounded-tl-3xl bg-gradient-to-r from-blue-900 to-gray-800 p-4 shadow text-2xl text-white">
                        <h1 class="font-bold pl-2">Evenementen</h1>
                    </div>
                </div>
...
<div class="container">
    <h1 class="title mt-4">Evenement Collection</h1>
        ...
        <a class="button" href="create.php">Add new evenement</a>
        <table class="table is-striped mt-4">
            ...
            <?php foreach ($eventAlbums as $index => $evenement): ?>
                <tr>
                    ...
                    <td class="is-vcentered"><a href="details.php?id=<?= $evenement['id'] ?>">Details</a></td>
                    <td class="is-vcentered"><a href="update.php?id=<?= $evenement['id'] ?>">Edit</a></td>
                    <td class="is-vcentered"><a href="delete.php?id=<?= $evenement['id'] ?>">Delete</a></td>
                </tr>
            <?php endforeach; ?>
            </tbody>
        </table>
