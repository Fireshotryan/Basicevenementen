...
if (isset($_POST['submit'])) {
    ...
    if (empty($errors)) {
        ...
        $query = "INSERT INTO evenementen (evname, date, description, image)
                  VALUES ('$evname', '$date', '$description', '$image')";
            ...
            <form class="column is-6" action="" method="post" enctype="multipart/form-data">
                <div class="field is-horizontal">
                    ...
                    <div class="field-body">
                        <input class="input" id="evname" type="text" name="evname" value="<?= isset($evname) ? htmlentities($evname) : '' ?>"/>
                        <span class="errors"><?= $errors['evname'] ?? '' ?></span>
                    </div>
                </div>
                <div class="field is-horizontal">
                    <div class="field-label is-normal">
                ...
                <div class="field is-horizontal">
                    ...
                    <div class="field-body">
                        <input class="input" id="description" type="text" name="description" value="<?= isset($description) ? htmlentities($description) : '' ?>"/>
