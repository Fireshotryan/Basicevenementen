...
<head>
    ...
    <title>evenementen systeem</title>
...
<nav
      ...
      >
       ...
       <div class="hidden w-full md:flex md:items-center md:w-auto" id="menu">
          ...
          >
            <li>
              <a class="md:p-4 py-2 block hover:text-purple-400" href="index.php"
                >Home</a
              >
            </li>
            <li>
              <a class="md:p-4 py-2 block hover:text-purple-400" href="contact.php"
                >Contact</a
              >
            </li>
            <li>
          ...
          <div class="relative overflow-hidden bg-no-repeat bg-cover" style="background-position: 50%; background-image: url('/images/evenementnissewaard.jpg');
          height: 500px;">
            <div class="absolute top-0 right-0 bottom-0 left-0 w-full h-full overflow-hidden bg-fixed" style="background-color: rgba(0, 0, 0, 0.75);">
              <div class="flex justify-center items-center h-full">
                <div class="text-center text-white px-6 md:px-12">
                  <h1 class="text-5xl md:text-6xl xl:text-7xl font-bold tracking-tight mb-12">Maak een account aan <br /><span>om een evenement te organiseren</span></h1>
                  <a class="inline-block px-7 py-3 mr-1.5 border-2 border-white text-white font-medium text-sm leading-snug uppercase rounded-full shadow-md hover:bg-black hover:bg-opacity-5 focus:outline-none focus:ring-0 transition duration-150 ease-in-out" data-mdb-ripple="true" data-mdb-ripple-color="light" href="login.php" role="button">Log in</a>
                </div>
              </div>
            </div>
          </div>
